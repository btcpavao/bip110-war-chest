...
export const dashboardSchema = envelopeSchema.extend({
  ...
  simpleView: z.object({
    fightCostSoFarUsd: z.number().nullable(),
    currentArmyCostPerDayUsd: z.number().nullable(),
    matchF2PoolCostPerDayUsd: z.number().nullable(),
    kratterCommittedUsd: z.number().nullable(),
    kratterMaximumLossUsd: z.number().nullable(),
    psuAnnualPriceUsd: z.number().positive(),
    secondsUntilMandatory: z.number().int().nonnegative(),
    bip110SevenDayEhS: z.number().nonnegative(),
    f2poolSevenDayEhS: z.number().nonnegative().nullable(),
    reinforcementsNeededEhS: z.number().nonnegative().nullable(),
    f2poolMatchedPct: z.number().nonnegative().nullable(),
    fredCommitmentOptionsUsd: z.tuple([
      z.number().positive(),
      z.number().positive(),
      z.number().positive(),
    ]),
    rentHashRateUrl: z.string().url(),
    historicalKratter: z.object({
